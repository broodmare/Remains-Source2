package fe.unit {
	...
	public class UnitBossAlicorn extends UnitPon {
		...
		private var shitMaxHp:Number=400;
		private var isShit:Boolean=true;
		...
		public function UnitBossAlicorn(cid:String=null, ndif:Number=100, xml:XML=null, loadObj:Object=null) {
			...
			visshit = SymbolFactory.createInstance("visShit3") as MovieClip;
		...
		private function emit(n:int=-1):void {
